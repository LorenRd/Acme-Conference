...
<form:form action="activity/administrator/presentation/create.do?conferenceId=${param['conferenceId']}" modelAttribute="presentation">
		<form:hidden path="id"/>
		...
		<br />
		<acme:textbox code="presentation.cameraReady" path="cameraReadyVersion"/>
		<br />
